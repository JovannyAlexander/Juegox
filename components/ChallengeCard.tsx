  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-3 relative z-20">
        <div className="bg-gradient-to-br from-purple-600/90 via-pink-600/90 to-red-600/90 rounded-full p-2 seductive-glow border border-white/30">
          <span className="text-lg">⚡</span>
        </div>
        <h3 className="text-lg md:text-xl font-black text-pink-200 neon-text">
          Desafío Extremo
        </h3>
      </div>
